  ...
  const slides = [
    {
      ...
      description:
        "Join thousands of developers building amazing projects together. Share knowledge, collaborate in real-time, and grow your skills.",
      image:
    ...
    },
    {
      ...
      description:
        "Access our comprehensive suite of development tools, cloud services, and collaborative features designed to supercharge your workflow.",
      image:
    ...
    },
    {
      ...
      description:
        "Connect with like-minded developers, participate in coding challenges, and get expert guidance from our thriving community.",
      image:
    ...
    <div className="relative h-[100vh] overflow-hidden">
      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div
            className={`absolute inset-0 ${slide.overlay} backdrop-blur-[2px]`}
          />
      ...
      {/* Content Container */}
      <div
        className={`relative z-10 flex items-center justify-center h-full transition-all duration-700 ${
          isVisible
