    ...
    return (
      <section className="py-20 relative overflow-hidden bg-gradient-to-br from-purple-900 via-violet-800 to-purple-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute -bottom-60 -left-60 w-96 h-96 bg-gradient-to-br from-violet-500/30 to-blue-500/20 rounded-full blur-3xl animate-float-slow"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[...Array(4)].map((_, index) => (
              <div
                key={index}
                className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-2xl p-6 animate-pulse border border-white/10"
              >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-2xl p-12 border border-white/20">
            ...
            <p className="text-white/60 text-lg mb-8 max-w-md mx-auto">
              Our team is curating the most amazing products to feature here.
              Check back soon for inspiring innovations!
            </p>
            <Link
              to="/products"
  ...
  return (
    <section className="py-20 relative overflow-hidden bg-gradient-to-br from-purple-900 via-violet-800 to-purple-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -bottom-80 -left-80 w-96 h-96 bg-gradient-to-br from-violet-500/40 to-blue-500/30 rounded-full blur-3xl animate-float-slow"
          style={{ animationDelay: "3s" }}
        ></div>
        ...
        <div
          className="absolute bottom-1/4 right-1/3 w-64 h-64 bg-gradient-to-br from-indigo-500/25 to-violet-500/25 rounded-full blur-3xl animate-float"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
            Hand-picked by our team of experts. Discover the most groundbreaking
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-white/20 hover:border-purple-400/50 transition-all duration-500 transform hover:-translate-y-2 relative">
                  ...
                  <div className="relative overflow-hidden bg-gradient-to-br from-white/5 to-white/10">
                    <div className="aspect-w-16 aspect-h-10 relative">
                      <img
                        ...
                        onError={(e) => {
                          e.target.src =
                            "https://via.placeholder.com/400x300/8B5CF6/FFFFFF?text=Innovation+Spotlight";
                        }}
                      />
                  ...
                  <div className="p-6 relative z-10">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-white/10">
                      ...
                      <button
                        onClick={() =>
                          handleUpvote(product._id, product.owner.email)
                        }
        ...
        <div className="text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 shadow-2xl">
            ...
            <p className="text-white/70 mb-8 max-w-2xl mx-auto">
              Explore thousands of innovative products, tools, and technologies
              shared by our global community of developers and creators.
            </p>
            <Link
              to="/products"
