    ...
    try {
      ...
      if (stripeError) {
        ...
        if (
          ...
          stripeError.decline_code === "fraudulent"
        ) {
          throw new Error(
            "This card has been declined due to suspected fraudulent activity. Please use a different card."
          );
        }
      ...
      if (paymentIntent.status === "succeeded") {
        ...
        toast.success(
          "🎉 Payment successful! Your membership has been upgraded to Premium."
        );
        onSuccess();
      } else {
      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <p className="text-xs text-gray-500 text-center">
            💳 Secure payment powered by Stripe. Your card details are protected
            by advanced fraud detection.
          </p>
        </form>
      </div>
    </div>
