        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[...Array(6)].map((_, index) => (
              <div
                key={index}
                className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl p-6 animate-pulse"
              >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-12 border border-white/20">
            ...
            <p className="text-gray-600 text-lg mb-8 max-w-md mx-auto">
              Be the first to discover and upvote amazing products! The
              community is waiting to see what's hot.
            </p>
            <Link
              to="/products"
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-white via-orange-50/30 to-red-50/20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -bottom-40 -left-40 w-80 h-80 bg-red-200/20 rounded-full blur-3xl animate-float"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover what's capturing the community's attention. These products
            are gaining momentum and shaping the future of technology right now.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-white/20 hover:border-orange-200/50 transition-all duration-500 transform hover:-translate-y-2 relative">
                  ...
                  {isTopProduct && (
                    <div
                      className={`absolute top-4 left-4 z-20 w-12 h-12 rounded-full flex items-center justify-center text-white font-black text-lg shadow-2xl ${
                        index === 0
                  ...
                  <div className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-orange-50/30">
                    <div className="aspect-w-16 aspect-h-10 relative">
                      <img
                        ...
                        onError={(e) => {
                          e.target.src =
                            "https://via.placeholder.com/400x300/F59E0B/FFFFFF?text=Trending+Now";
                        }}
                      />
                      {/* Shine Effect */}
                  ...
                  <div className="p-6 relative z-10">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100/50">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div
                          className={`flex items-center space-x-2 px-3 py-1 rounded-full bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200/50 ${
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 backdrop-blur-sm rounded-3xl p-8 border border-orange-200/30 shadow-2xl">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Explore thousands of products and discover what's capturing the
              community's attention. Your next favorite innovation is just a
              click away.
            </p>
            <Link
              to="/products"
