            ...
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
              <div className="aspect-w-16 aspect-h-12 bg-gray-100">
                <img
                  ...
                  onError={(e) => {
                    e.target.src = 'https://via.placeholder.com/600x400/8B5CF6/FFFFFF?text=Product+Image';
                  }}
                />
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8">
              <div className="flex items-start justify-between mb-6">
                ...
                <div className="ml-6 flex-shrink-0">
                  ...
                  >
                    ...
                    <span className="text-lg font-bold">{product.votes || 0}</span>
                    <span className="text-xs">Upvotes</span>
                    {upvoting && (
                      <svg className="animate-spin h-4 w-4 text-white absolute" fill="none" viewBox="0 0 24 24">
              ...
              <div className="mb-6 p-4 bg-gray-50 rounded-2xl">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <p className="font-semibold text-gray-900">{product.owner.name}</p>
                  ...
                  {reviews.map((review) => (
                    <div key={review._id} className="border-b border-gray-200 pb-6 last:border-b-0">
                      <div className="flex items-start space-x-4">
                        <img
                          src={review.reviewerImage || "https://www.w3schools.com/w3images/avatar2.png"}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-gray-600 mb-2 leading-relaxed">{review.description}</p>
