      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-yellow-50 to-amber-100 rounded-2xl p-6 text-center border border-yellow-200">
            <div className="text-2xl font-bold text-yellow-600">
              ...
              {coupons
                .reduce(
                  (total, coupon) =>
                    total + coupon.discountAmount * (coupon.usedCount || 0),
                  0
                )
                .toFixed(2)}
            </div>
                ...
                <div className="space-y-3 mb-4">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-xl p-3">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span
                        className={`font-bold ${
                          getDaysRemaining(coupon.expiryDate) <= 7
                            ? "text-red-600"
                            : "text-blue-600"
                        }`}
                      >
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-2xl p-6">
          ...
          <ul className="text-sm text-blue-700 space-y-2">
            <li>
              • <strong>Coupon Codes</strong> should be unique and easy to
              remember
            </li>
            <li>
              • Set <strong>Maximum Uses</strong> to limit how many times a
              coupon can be used
            </li>
            <li>
              • Use <strong>Minimum Order Amount</strong> to ensure meaningful
              purchases
            </li>
            <li>• Monitor coupon usage and expiry dates regularly</li>
            <li>
              • Consider creating seasonal or promotional coupons for special
              events
            </li>
          </ul>
        </div>
